...
CREATE TEMPORARY TABLE TRANSANCTION_SEARCH_RESULT(
	...
	VATAMOUNT DECIMAL(12, 3) UNSIGNED DEFAULT 0.000,
	DISCOUNT DECIMAL(12, 3) UNSIGNED DEFAULT 0.000,
	CASHPAYMENT DECIMAL(12, 3) UNSIGNED DEFAULT 0.000,
	CARDPAYMENT DECIMAL(12, 3) UNSIGNED DEFAULT 0.000,
	CHEQUEPAYMENT DECIMAL(12, 3) UNSIGNED DEFAULT 0.000,
	NEFTPAYMENT DECIMAL(12, 3) UNSIGNED DEFAULT 0.000,
	RGTSPAYMENT DECIMAL(12, 3) UNSIGNED DEFAULT 0.000
);
CREATE TEMPORARY TABLE TRANSANCTION_ID_HOLDER(
	TRANSID BIGINT UNSIGNED
);
INSERT INTO TRANSANCTION_SEARCH_RESULT(TRANSDATE, TRANSID, BILLTYPE, TRANSACTIONSTATUS, CUSTOMERNAME, CONTACTNUMBER, EMAILID, ADDRESS, TOTALITEMSPRICE, VATAMOUNT, DISCOUNT,
	CASHPAYMENT, CARDPAYMENT, CHEQUEPAYMENT, NEFTPAYMENT, RGTSPAYMENT)
	SELECT 	RT.TRANSDATE,
			RT.TRANSID,
			RT.BILLTYPE,
			...
			RP.DISCOUNT,
			RTP.CASHPAYMENT,
			RTP.TOTALCARDPAYMENT,
			RTP.CHEQUEPAYMENT,
			RTP.NEFTPAYMENT,
			RTP.RGTSPAYMENT
			FROM SHOP S, RETAILTRANSACTION RT, RETAILCUSTOMER RC, RETAILTRANSACTIONPRICE RP, RETAILTRANSACTIONPAYMENT RTP
