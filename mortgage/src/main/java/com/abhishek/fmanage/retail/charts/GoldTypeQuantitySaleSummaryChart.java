 ...
 */
public class GoldTypeQuantitySaleSummaryChart {
    public Component getChart(List<GoldTypeQuantitySaleSummaryDTO> itemSummary, String title) {
    ...
    private Chart createPieChart(List<GoldTypeQuantitySaleSummaryDTO> itemSummary, String title) {
        ...
        for(GoldTypeQuantitySaleSummaryDTO summary : itemSummary){
            series.add(new DataSeriesItem(summary.getGoldType(), summary.getQuantity()));
        }
